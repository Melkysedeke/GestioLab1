...
<%@ page import="br.com.gestio.model.Divida" %>
<%@ page import="br.com.gestio.model.Categoria" %>
<%
    Usuario usuario = (Usuario) session.getAttribute("usuarioSessao");
	List<Divida> dividas = (List<Divida>) session.getAttribute("dividasSessao");
  ...
  <head>
    ...
    <style>
      * {
      ...
      .tabela-dividas thead th {
      	font-size: 15px;
      	width: auto;
      }
      
      .tabela-dividas tbody tr {
      	height: 30px;
  ...
  <body>
    ...
    <main>
      ...
      <div class="tela">
        ...
        <section id="dividas" class="secao-dividas">
		  <div class="topo-dividas">
		  ...
		  <div class="modal-content">
		    <form action="<%= request.getContextPath() %>/DividaController" method="post" class="form-movimentacao">
		      ...
		      <div class="botoes-tipo">
		        <input type="radio" name="tipo" value="Dívida" id="divida" checked hidden>
		        <label for="divida" class="botao-tipo">Dívida</label>
		
		        <input type="radio" name="tipo" value="Empréstimo" id="emprestimo" hidden>
		        <label for="emprestimo" class="botao-tipo">Empréstimo</label>
		      </div>
		
		      <label for="descricao" class="label-input">Descrição</label>
		      <input type="text" name="descricao" id="descricao" placeholder="Ex: Empréstimo ao João, Cartão Nubank..." class="input-texto">
		
		      <div class="linha-dupla">
		        <div class="campo">
		          <label for="dataCriacao" class="label-input">Data de Criação</label>
		          <input type="date" name="dataCriacao" id="dataCriacao" class="input-texto" readonly
		                 value="<%= new java.text.SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date()) %>">
		        </div>
		
		        <div class="campo">
		          <label for="dataVencimento" class="label-input">Data de Vencimento</label>
		      ...
		      <input type="number" step="0.01" name="valor" id="valor" class="input-texto" placeholder="R$ 0,00">
		
		      <div class="botoes-acoes">
		        <button type="submit" class="botao salvar">Salvar</button>
		        <button type="button" onclick="fecharModalDivida()" class="botao cancelar">Cancelar</button>
		      </div>
		    </form>
		  </div>
		</div>
		...
		<div id="modalEditarDivida" class="modal-overlay" style="display: none">
		  <div class="modal-content">
		    <form action="<%= request.getContextPath() %>/DividaController" method="post" class="form-movimentacao">
		      ...
		      <h2 class="titulo-form">Editar Dívida ou Empréstimo</h2>
		
		      <div class="botoes-tipo" id="editarTipoDivida">
		        <input type="radio" name="tipo" value="Dívida" id="editarDivida" hidden />
		        <label for="editarDivida" class="botao-tipo">Dívida</label>
		
		        <input type="radio" name="tipo" value="Empréstimo" id="editarEmprestimo" hidden />
		        <label for="editarEmprestimo" class="botao-tipo">Empréstimo</label>
		      </div>
		
		      <label for="editarDescricaoDivida" class="label-input">Descrição</label>
		      <input type="text" name="descricao" id="editarDescricaoDivida" class="input-texto" placeholder="Ex: Empréstimo ao João, Cartão Nubank..." />
		
		      <div class="linha-dupla">
		        <div class="campo">
		          <label for="editarDataCriacao" class="label-input">Data de Criação</label>
		          <input type="date" name="dataCriacao" id="editarDataCriacao" class="input-texto" readonly />
		        </div>
		
		        <div class="campo">
		          <label for="editarDataVencimento" class="label-input">Data de Vencimento</label>
		          <input type="date" name="dataVencimento" id="editarDataVencimento" class="input-texto" />
		        </div>
		      </div>
		
		      <label for="editarDataQuitacao" class="label-input">Data de Quitação</label>
		      <input type="date" name="dataQuitacao" id="editarDataQuitacao" class="input-texto" />
		      ...
		      <div class="botoes-acoes">
		        <button type="submit" class="botao salvar">Salvar</button>
		        <button type="button" onclick="fecharModalEditarDivida()" class="botao cancelar">Cancelar</button>
		      </div>
		    </form>
		  </div>
		</div>
   ...
   // alterna página
	  ...
	  window.onclick = function(event) {
	    ...
	    const modalEditar = document.getElementById('modalEditarDivida');
